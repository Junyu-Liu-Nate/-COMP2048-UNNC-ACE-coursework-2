...
- **Class Main( )**
  ...
  - **Methods:**
    ...
    - **public static ArrayList<String> ReadInput()** - Read the user input, and separate the input string into an ArrayList of tokens.
    - **public static ArrayList<String> ConvertToSuffix(ArrayList<String> strInfix)** - Convert the Infix-represented ArrayList of tokens into a suffix-represented list, in order to prepare for putting it into a tree.
